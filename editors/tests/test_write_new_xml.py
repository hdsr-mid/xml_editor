from editors.constants import TEST_INPUT_DIR
...
def test_new_mwm_xml_has_no_namespace():
    xml_1 = TEST_INPUT_DIR / "20151215104633_HDSR_PS1313_Waterlevel.xml"
    xml_2 = TEST_INPUT_DIR / "20210601151504_HDSR_PS2220_Waterlevel.xml"
